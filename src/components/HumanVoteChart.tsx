...
export const HumanVoteChart: React.FC<HumanVoteChartProps> = ({
  data,
}) => {
  if (data.length === 0) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Human Vote History</CardTitle>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Human Vote History</CardTitle>
        <CardDescription>
          Showing cumulative human votes over time
        </CardDescription>
      </CardHeader>
      <CardContent>
